...
using TextSearcher.Extensions;
using TextSearcher.FileSearcher;
using TextSearcher.FileSearcher.EventArgs;
using TextSearcher.FileSearcher.Helpers;
...
namespace TextSearcher
{
    ...
    public partial class FormMain : Form
    {
        ...
        private void sfsAboutButton_Click(object sender, EventArgs e) => MessageBox.Show(
            T._("The program is designed for full-text search in files with specified search criteria.") + "\n" + T._("Author: NataliaZhydeikina (https://github.com/NataliaZhydeikina/TextSearcher), august 2021."),
